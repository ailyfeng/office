...
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 
    ...
    <span class="c-gray en">&gt;</span> 供应商管理<span class="c-gray en"></span> 
...
<div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray">
        <span class="l">
            ...
            <a class="btn btn-primary radius" data-title="添加产品" _href="{{url('cms/supplier/create')}}" onclick="Hui_admin_tab(this)" href="javascript:;">
