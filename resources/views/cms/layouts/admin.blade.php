...
<!--[if lt IE 9]>
<script type="text/javascript" src="{{asset('resources/cms/lib/html5.js')}}"></script>
<script type="text/javascript" src="{{asset('resources/cms/lib/respond.min.js')}}"></script>
<script type="text/javascript" src="{{asset('resources/cms/lib/PIE_IE678.js')}}"></script>
<![endif]-->
