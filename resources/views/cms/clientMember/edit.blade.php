            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    @if($errors->has('contractDate'))
                        <input type="text" name="birthday" id="birthday" class=" input-text radius error" aria-required="true" value="{{$data->birthday}}" readonly  aria-invalid="true">
                        <label id="birthday-error" class="error" for="birthday">{{$errors->first('contractDate')}}</label>
                    @else
                        <input type="text" name="birthday" id="birthday" class=" input-text radius " readonly value="{{$data->birthday}}" placeholder="0000-00-00">
