...
<nav class="breadcrumb">
    <i class="Hui-iconfont">&#xe67f;</i> <a href="{{url('cms/index/info')}}" >首页 </a><span class="c-gray en">&gt;</span> 
        ...
        添加客户联系人 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
    <article class="page-container">
        <form action="{{url('cms/clientMember')}}" method="post" class="form form-horizontal" id="formSupplierAdd">
            {{csrf_field()}}
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    @if($errors->has('age'))
                        <input type="text" name="age" class=" input-text radius error" aria-required="true"  aria-invalid="true">
                        <label id="age-error" class="error" for="age">{{$errors->first('age')}}</label>
                    @else
                        <input type="text" name="age" class=" input-text radius "  placeholder="">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    @if($errors->has('age'))
                        <input type="text" name="phone" class=" input-text radius error" aria-required="true"  aria-invalid="true">
                        <label id="phone-error" class="error" for="phone">{{$errors->first('phone')}}</label>
                    @else
                        <input type="text" name="phone" class=" input-text radius "  placeholder="">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    ...
                    @else
                        <input type="text" name="phoneExt" class=" input-text radius "  placeholder="">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    @if($errors->has('account'))
                        <input type="text" name="account" class=" input-text radius error" aria-required="true"  aria-invalid="true">
                        <label id="account-error" class="error" for="account">{{$errors->first('account')}}</label>
                    @else
                        <input type="text" name="account" class=" input-text radius "  placeholder="">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    @if($errors->has('bargainNum'))
                        <input type="text" name="bargainNum" class=" input-text radius error" aria-required="true"  aria-invalid="true">
                        <label id="bargainNum-error" class="error" for="bargainNum">{{$errors->first('bargainNum')}}</label>
                    @else
                        <input type="text" name="bargainNum" class=" input-text radius "  placeholder="">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    @if($errors->has('description'))
                        <input type="text" class="input-text radius error" value="" name="description" aria-required="true" aria-invalid="true">
                        <label id="description-error" class="error" for="description">{{$errors->first('description')}}</label>
                    @else
                        <input type="text" class="input-text radius " value="" placeholder="" name="description" >
                    @endif
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    @if($errors->has('note'))
                        <textarea class="textarea radius error" name="note" placeholder="附注" aria-required="true" aria-invalid="true"></textarea>
