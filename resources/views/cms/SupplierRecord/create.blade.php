...
<div class="page-container">
    <article class="page-container">
        <form action="{{url('cms/supplierRecord')}}" method="post" class="form form-horizontal" id="formSupplierRecordAdd">
            {{csrf_field()}}

            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>供应商：</label>
                <div class="formControls col-xs-8 col-sm-9">
                        <input type="hidden" name="supplierId" value="" class="supplierId">
                    @if($errors->has('supplierId'))
                        <input type="text" class="input-text radius error" value=""  readonly="readonly" name="supplierId_" id="supplierId" placeholder="请选择供应商" onclick="actionEdit('选择供应商','{{url('cms/supplier?selectSupplier=1')}}&sonId=supplierId&sonName=supplierId','1')" aria-required="true" aria-invalid="true">
                        <label id="supplierId-error" class="error" for="supplierId">{{$errors->first('supplierId')}}</label>
                    @else
                         <input type="text" class="input-text radius" value="" readonly="readonly" placeholder="请选择供应商" name="supplierId_" id="supplierId" onclick=" actionEdit('选择供应商','{{url('cms/supplier?selectSupplier=1')}}&sonId=supplierId&sonName=supplierId','1');" aria-required="true" aria-invalid="true">
                    @endif
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    @if($errors->has('timestamp'))
                        <input type="text" name="timestamp" id="timestamp" class=" input-text radius error" aria-required="true" readonly  aria-invalid="true">
                        <label id="timestamp-error" class="error" for="timestamp">{{$errors->first('timestamp')}}</label>
                    @else
                         <input type="text" name="timestamp" id="timestamp" class=" input-text radius " readonly value="{{$supplierRecord['timestamp']}}"  placeholder="0000-00-00">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    ...
                    @if($errors->has('memberId'))
                        <input type="text" class="input-text radius error" value=""  readonly="readonly" name="memberId_" id="memberId" placeholder="请选择联系人" onclick="actionEdit('请选联系人','{{url('cms/warehouse?selectSupplier=1')}}&sonId=memberId&sonName=memberId','1')" aria-required="true" aria-invalid="true">
                        <label id="memberId-error" class="error" for="memberId">{{$errors->first('memberId')}}</label>
                    @else
                         <input type="text" class="input-text radius" value="" readonly="readonly" placeholder="请选择库房" name="memberId_" id="memberId" onclick=" actionEdit('请选联系人','{{url('cms/warehouse?selectSupplier=1')}}&sonId=memberId&sonName=memberId','1');" aria-required="true" aria-invalid="true">
                    @endif
                </div>
            </div>
            <div class="row cl">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    ...
                    <textarea class="textarea radius error" name="record" placeholder="" aria-required="true" aria-invalid="true"></textarea>
                        <label id="account-error" class="error" for="record">{{$errors->first('record')}}</label>
                    @else
                        <textarea class="textarea radius" name="record" placeholder="250个字符" onKeyUp="textarealength(this,250)"></textarea>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    ...
                    <textarea class="textarea radius error" name="keepRecords" placeholder="" aria-required="true" aria-invalid="true"></textarea>
                        <label id="account-error" class="error" for="keepRecords">{{$errors->first('keepRecords')}}</label>
                    @else
                        <textarea class="textarea radius" name="keepRecords" placeholder="250个字符" onKeyUp="textarealength(this,250)"></textarea>
                        <p class="textarea-numberbar"><em class="textarea-length">0</em>/250</p>
                    @endif
                </div>
            </div>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    ...
                    <textarea class="textarea radius error" name="presentRecords" placeholder="" aria-required="true" aria-invalid="true"></textarea>
                        <label id="account-error" class="error" for="presentRecords">{{$errors->first('presentRecords')}}</label>
                    @else
                        <textarea class="textarea radius" name="presentRecords" placeholder="250个字符" onKeyUp="textarealength(this,250)"></textarea>
                        <p class="textarea-numberbar"><em class="textarea-length">0</em>/250</p>
                    @endif
                </div>
            </div>
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    @if($errors->has('nextTimestamp'))
                        <input type="text" name="nextTimestamp" id="nextTimestamp" class=" input-text radius error" aria-required="true" readonly  aria-invalid="true">
                        <label id="nextTimestamp-error" class="error" for="nextTimestamp">{{$errors->first('nextTimestamp')}}</label>
                    @else
                         <input type="text" name="nextTimestamp" id="nextTimestamp" class=" input-text radius " readonly  placeholder="0000-00-00">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    ...
                    <textarea class="textarea radius error" name="nextContent" placeholder="" aria-required="true" aria-invalid="true"></textarea>
                        <label id="account-error" class="error" for="nextContent">{{$errors->first('nextContent')}}</label>
                    @else
                        <textarea class="textarea radius" name="nextContent" placeholder="250个字符" onKeyUp="textarealength(this,250)"></textarea>
                        <p class="textarea-numberbar"><em class="textarea-length">0</em>/250</p>
                    @endif
                </div>
            </div>
