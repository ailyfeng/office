...
@section("content")
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="#">首页</a> &raquo; <a href="{{url('cms/supplier')}}">供应商管理</a> &raquo; 修改供应商：{{$data->fullName}}
    </div>
    <!--面包屑导航 结束-->
        ...
        <form action="{{url('cms/supplier')}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="fullName" value="{{$data->fullName}}">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="abbreviation" value="{{$data->abbreviation}}">
                ...
                <tr>
                    ...
                    <td>
                        @foreach($type as $k=>$v)
                            <label><input name="type[]" type="checkbox" value="{{$k}}"
                                @foreach($data->type as $t) @if($k==$t)checked="checked" @endif @endforeach/>{{$v}}
                            </label>
                        @endforeach
                        @if($errors->has('type'))
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="brand" value="{{$data->brand}}">
                        @if($errors->has('brand'))
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="brandType" value="{{$data->brandType}}">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="officeAdd" value="{{$data->officeAdd}}">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="warehoustAdd" value="{{$data->warehoustAdd}}">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="area" value="{{$data->area}}">
                        @if($errors->has('area'))
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="settlementMmethod" class="md"  value="{{$data->settlementMmethod}}">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="paymentMethod" class="md" value="{{$data->paymentMethod}}">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="md" name="priceTax" placeholder="0000.00"  value="{{$data->priceTax}}">元
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="md" name="priceNoTax" placeholder="0000.00" value="{{$data->priceNoTax}}">元
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="account" class="md"  value="{{$data->account}}">
                ...
                <tr>
                    ...
                    <td>
                        @foreach($isBoolean as $k=>$v)
                            <label><input name="deliveryIs" type="radio" value="{{$k}}" @if($k==$data->deliveryIs)checked="checked" @endif  />{{$v}}</label>
                        @endforeach
                ...
                <tr>
                    ...
                    <td>
                        @foreach($isBoolean as $k=>$v)
                            <label><input name="signIs" type="radio" value="{{$k}}" @if($k==$data->signIs)checked="checked" @endif  />{{$v}}</label>
                        @endforeach
                ...
                <tr>
                    <th>退换货要求：</th>
                    <td>
                        <textarea class="mg" name="returnRequirements">{{$data->returnRequirements}}</textarea>
                ...
                <tr>
                    <th>合同简报：</th>
                    <td>
                        <textarea class="mg" name="contractBriefing">{{$data->contractBriefing}}</textarea>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="md" name="credit" value="{{$data->credit}}">
                ...
                <tr>
                    <th>备注：</th>
                    <td>
                        <textarea class="mg" name="note">{{$data->note}}</textarea>
                        @if($errors->has('note'))
