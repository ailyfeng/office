...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> 
			<a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">成都欧飞仕科技贸易有限公司</a>
			<a class="logo navbar-logo-m f-l mr-10 visible-xs" href="#">成都欧飞仕科技贸易有限公司</a> 
			<span class="logo navbar-slogan f-l mr-10 hidden-xs">v.d.1.0</span> 
...
<aside class="Hui-aside">
	...
	<div class="menu_dropdown bk_2">
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo e(url('cms/product')); ?>" data-title="公司产品" href="javascript:void(0)">公司产品</a></li>
					<li><a _href="<?php echo e(url('cms/classify')); ?>" data-title="公司产品" href="javascript:void(0)">产品分类</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<!-- <li><a _href="<?php echo e(url('cms/classify')); ?>" data-title="供应商类别管理" href="javascript:void(0)">供应商类别管理</a></li> -->
					<li><a _href="<?php echo e(url('cms/supplier')); ?>" data-title="供应商列表" href="javascript:void(0)">供应商列表</a></li>
					<li><a _href="<?php echo e(url('cms/supplierContract')); ?>" data-title="供应商联系人" href="javascript:void(0)">供应商联系人</a></li>
					<li><a _href="<?php echo e(url('cms/index/info')); ?>" data-title="供应商接触表" href="javascript:void(0)">供应商接触表</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo e(url('cms/warehouse')); ?>" data-title="库房列表" href="javascript:void(0)">库房列表</a></li>
					<li><a _href="<?php echo e(url('cms/warehouseProduct')); ?>" data-title="库房产品" href="javascript:void(0)">库房产品</a></li>
				</ul>
			</dd>
		</dl>
		<dl id="menu-product">
			...
			<dd>
				<ul>
					<li><a _href="<?php echo e(url('cms/supplier')); ?>" data-title="供应商" href="javascript:void(0)">供应商</a></li>
					<li><a _href="<?php echo e(url('cms/classify')); ?>" data-title="公司产品" href="javascript:void(0)">产品分类</a></li>
				</ul>
			</dd>
		</dl>
...
<section class="Hui-article-box">
	<div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
		<div class="Hui-tabNav-wp">
			<ul id="min_title_list" class="acrossTab cl">
				<li class="active"><span title="我的桌面" data-href="<?php echo e(url('cms/index/info')); ?>">我的桌面</span><em></em></li>
			</ul>
		</div>
	...
	<div id="iframe_box" class="Hui-article">
		<div class="show_iframe">
			...
			<iframe scrolling="yes" frameborder="0" src="<?php echo e(url('cms/index/info')); ?>"></iframe>
		</div>
	</div>
</section>
