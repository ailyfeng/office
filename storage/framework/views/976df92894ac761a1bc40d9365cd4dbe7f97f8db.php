...
<div class="page-container">
    ...
    <?php endif; ?>    
            ...
            <a class="btn btn-primary radius" href="<?php echo e(url('cms/supplier')); ?>">清空所有筛选</a> 
        </div>
        ...
        <div class="box-shadow">
            ...
            <?php foreach($whereField as $f=>$lista): ?>
                <a class="btn btn-primary size-MINI radius" href="<?php echo e(url('cms/supplier'.$lista['sortUrl'].'&page='.$data->currentPage())); ?>"><?php echo e($lista['name']); ?></a>
            <?php endforeach; ?>
    ...
    <div class="cl pd-5 bg-1 bk-gray">
        <span class="l">
            ...
            <a class="btn btn-primary radius" data-title="添加供应商" _href="<?php echo e(url('cms/supplier/create')); ?>" onclick="Hui_admin_tab(this)" href="javascript:;">
            ...
            <?php endforeach; ?>
                 ...
                 <td <?php if($list->close && !$selectSupplier): ?> class=" danger " <?php endif; ?>>
                   ...
                   <?php else: ?>
                    ...
                    <a style="text-decoration:none" data-title="添加供应商联系人" title="添加供应商联系人" _href="<?php echo e(url('cms/supplierContract/create/'.$list->supplierId)); ?>" onclick="Hui_admin_tab(this)" href="javascript:;">
                        <i class="Hui-iconfont">&#xe600;</i>
                    </a>
                    <a title="编辑" href="javascript:;" onclick="actionEdit('角色编辑','<?php echo e(url('cms/supplier/'.$list->supplierId.'/edit')); ?>','<?php echo e($list->supplierId); ?>')" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a> 
                    <?php endif; ?>
                </td>
            </tr>
            <?php endforeach; ?>
...
function actionDelete(id,status){
        ...
        if(status){
            ...
            if(tag){
                ...
                $.post("<?php echo e(url('cms/supplier/')); ?>/"+id,{'_method':'delete','_token':"<?php echo e(csrf_token()); ?>",'status':status},function(data){
