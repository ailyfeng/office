...
# Database: officeTest
# Generation Time: 2016-12-11 09:31:18 +0000
# ************************************************************
...
CREATE TABLE `classify` (
  ...
  `close` tinyint(1) DEFAULT '0' COMMENT '是否删除，1:删除；0:正常使用',
  `type` varchar(45) DEFAULT NULL COMMENT '该分类属于哪张表：1-product',
  PRIMARY KEY (`id`)
...
INSERT INTO `classify` (`id`, `parentId`, `name`, `sort`, `close`, `type`)
VALUES
	(1,0,'电脑','1',0,'1'),
	(2,0,'收到','2',0,'1'),
	(3,0,'打雷','3',0,'1'),
	...
	(16,7,'本子','7-16',0,'1'),
	(18,16,'书','7-16-18',0,'1'),
	(17,13,'5A','7-13-17',1,'1'),
	(19,8,'小小雷','3-8-19',0,'1'),
	(20,8,'小小雷','3-8-20',1,'1'),
	(21,8,' 小小雷1','3-8-21',1,'1'),
	(22,6,'炭笔','6-22',0,'1'),
	(23,9,'2B','6-9-23',1,'1'),
	(24,5,'打雷1','3-5-24',1,'1'),
	(25,6,'中类','6-25',0,'1');
...
VALUES
	...
	(29,'asdfasdf ','alskdjfaksj','s:13:\"[\"0\",\"1\",\"2\"]\";','ksajf;skdj','lkasjdlfkj','s;akdjf;alskjdf','alskjfd;alskdjf;kj ','kasjd;flkasjd ','skdjfklasjd','jfalksjdflakj',234123.00,2341234.00,'kjsakdfj ',1,1,'asdfasdfkjasklj卡索拉就地方啦深刻的萨科的肌肤阿斯顿','1481673600','','asdfsdf','',0),
	(26,'阿斯顿发水淀粉','skdjfkas','s:13:\"[\"0\",\"1\",\"2\"]\";','sdfasdfkjdas','sdkajfaskdjf','ksadjflaksdj','klasjdlfkjasldkjf','alksjdlfajlsdj','kajsldfjlj','lkjdskafjsldkaj',234234.00,423142314.00,'sdkjfkasjd',1,1,'asdfasdfkjaskljdflasjdk','1481673600','asdfasdf','faskdjfklaj','sadkfjaksdfl',0),
	...
	(33,'阿斯顿发送地方','说到发送地方','s:13:\"[\"0\",\"1\",\"2\"]\";','ksajf;skdj','lkasjdlfkj','s;akdjf;alskjdf','alskjfd;alskdjf;kj ','kasjd;flkasjd ','skdjfklasjd','jfalksjdflakj',234123.00,2341234.00,'kjsakdfj ',1,1,'asdfasdfkjasklj卡索拉就地方啦深刻的萨科的肌肤阿斯顿','1481673600','阿斯科利的肌肤啦深刻的肌肤撒放','是打开房间','撒离开的肌肤阿斯顿skald',0),
	...
	(36,'阿斯顿发撒地方asdf','不晓得df','s:13:\"[\"0\",\"1\",\"2\"]\";','卡萨肌肤抗衰老的','lkasjdlfkj','s;akdjf;alskjdf','alskjfd;alskdjf;kj ','kasjd;flkasjd ','skdjfklasjd','jfalksjdflakj',234123.00,2341234.00,'kjsakdfj ',1,1,'asdfasdfkjasklj卡索拉就地方啦深刻的萨科的肌肤阿斯顿','1481673600','阿斯科利的肌肤啦深刻的肌肤撒放','是打开房间','撒离开的肌肤阿斯顿skald',0),
...
VALUES
	(1,'大家是否卡设计的课','看见阿斯利康的肌肤 ',234234.00,32412,'将卢卡斯大家发开始','23就撒了大家发来上课就地方',234.00,34234.00,1480809600,1480809600,1),
	...
	(41,'大看风使舵','啊谁看得见发是快乐的经历',234234.00,332,'啦可是大家发可是大家发','是会计法律框架地方啦可是',234234.00,4324243.00,1482278400,1481673600,0),
	(42,'阿斯顿发水淀粉dfasdf','但是发送到发送地方',234234.00,1111,'ksjadlfk ','aksjdfl ',34234.00,3243.00,1480896000,1482192000,0),
